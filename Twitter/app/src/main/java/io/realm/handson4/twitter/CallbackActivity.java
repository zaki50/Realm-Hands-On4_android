...
public class CallbackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RequestToken requestToken = TwitterAuthUtil.loadRequestToken(this);
        TwitterAuthUtil.clearTokens(this);
        ...
        new AsyncTask<Void, Throwable, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    TwitterAuthUtil.saveAccessToken(CallbackActivity.this, accessToken);
                    startMainActivity();
